export const Search = () => {
  ...
  // const str = `Search ${searchInput.value.length > 0 ? 'by' : ''}`; // динамичный текст, если что-то написали в инпут, то by появится
  searchTitle.textContent = 'Search by'; // обычный текст, тупо текст
